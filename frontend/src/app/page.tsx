...
function TierBadge({ filings }: { filings: number }) {
  if (filings >= 50) return (
    <span style={{ background: "linear-gradient(135deg, #F59E0B, #D97706)", color: "#1a1a2e", fontSize: "10px", fontWeight: 800, padding: "3px 8px", borderRadius: "4px", letterSpacing: "0.08em", textTransform: "uppercase" as const }}>
      ★ Platinum
    </span>
  );
  if (filings >= 10) return (
    <span style={{ background: "linear-gradient(135deg, #6366F1, #4F46E5)", color: "white", fontSize: "10px", fontWeight: 800, padding: "3px 8px", borderRadius: "4px", letterSpacing: "0.08em", textTransform: "uppercase" as const }}>
      ◆ Gold
    </span>
  );
  return (
    <span style={{ background: "rgba(255,255,255,0.08)", color: "#94A3B8", fontSize: "10px", fontWeight: 700, padding: "3px 8px", borderRadius: "4px", letterSpacing: "0.08em", textTransform: "uppercase" as const }}>
      Sponsor
    </span>
  );
}
...
function ScoreRing({ score }: { score: number }) {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "2px", minWidth: "52px" }}>
      ...
      <span style={{ fontSize: "9px", color: "#64748B", letterSpacing: "0.05em", textTransform: "uppercase" as const }}>match</span>
    </div>
  );
}
    ...
    >
      ...
      {expanded && insight && (
        <div style={{
          ...
          borderRadius: "0 8px 8px 0", fontSize: "13px", color: "#CBD5E1", lineHeight: 1.7,
        }}>
          {insight}
        </div>
      )}
...
export default function Home() {
  ...
  async function handleSearch() {
    ...
    setCurrentYear(year);
    posthog.capture("search", { query, state, year });
    try {
  ...
  async function handleLoadMore() {
    ...
    try {
      const res = await axios.post(`${API}/search`, {
        ...
        fiscal_year: currentYear ? parseInt(currentYear) : null,
        limit: 20,
  ...
  return (
    <main style={{ minHeight: "100vh", background: "#0A0F1E", color: "#F1F5F9", fontFamily: "'DM Sans', system-ui, sans-serif" }}>
      ...
      <header style={{
        ...
        background: "rgba(10,15,30,0.8)", backdropFilter: "blur(12px)", padding: "0 24px",
      }}>
        <div style={{ maxWidth: "900px", margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between", height: "64px" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
            ...
            <div style={{ fontSize: "11px", color: "#334155" }}>FY2025–2026</div>
          </div>
        </div>
      </header>
      ...
      <div style={{ position: "relative", zIndex: 10, maxWidth: "900px", margin: "0 auto", padding: "40px 24px" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: "48px" }}>
          ...
          <p style={{ fontSize: "16px", color: "#475569", margin: "0 0 8px", maxWidth: "480px", marginLeft: "auto", marginRight: "auto", lineHeight: 1.6 }}>
            Semantic search across 400,000+ real DOL filings. No guesswork — real companies, real salaries, real data.
          </p>
        ...
        <div style={{ display: "flex", gap: "4px", marginBottom: "24px", background: "rgba(255,255,255,0.04)", padding: "4px", borderRadius: "12px", width: "fit-content" }}>
          {[
            ...
            <button key={t.id} onClick={() => setTab(t.id as "search" | "match")}
              style={{
              ...
              <div style={{ display: "flex", gap: "12px", flexWrap: "wrap" }}>
                ...
                <button
                  ...
                  style={{
                    ...
                    fontSize: "14px", fontWeight: 700, cursor: searching ? "wait" : "pointer",
                ...
                {["software engineer", "data scientist", "product manager", "DevOps engineer"].map(s => (
                  <button key={s} onClick={() => setQuery(s)}
                    style={{
                      ...
                      color: "#64748B", fontSize: "11px", cursor: "pointer", transition: "all 0.15s",
                    }}
            ...
            {searchResults.length > 0 && (
              <div style={{ marginBottom: "12px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                <span style={{ fontSize: "12px", color: "#334155" }}>
                  ...
                  {year && <span style={{ color: "#475569" }}> · FY{year}</span>}
                </span>
                <span style={{ fontSize: "11px", color: "#1E293B", letterSpacing: "0.04em", textTransform: "uppercase" as const }}>
                  Sorted by relevance
                </span>
              </div>
            )}
              ...
              <div style={{ textAlign: "center", marginTop: "24px" }}>
                <button
                  ...
                  style={{
                    ...
                    cursor: searching ? "wait" : "pointer", transition: "all 0.2s",
                  }}
          ...
          <div>
            <div style={{
              ...
              <p style={{ margin: "0 0 20px", fontSize: "13px", color: "#475569", lineHeight: 1.6 }}>
                Upload your PDF or DOCX resume. We will find H1B sponsors whose filings semantically match your skills using vector similarity.
              </p>
